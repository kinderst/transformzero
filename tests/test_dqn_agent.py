...
class DQNAgentTests(unittest.TestCase):
    def loop_train_and_eval(self, agent, early_stopping_rounds, early_stopping_threshold, eval_threshold, name_string,
        ...
        print(f"{name_string} train results: {avg_train_results}, eval results: {avg_eval_results}")
    ...
    def test_train_and_eval_gridnone_resnet(self):
        ...
        self.loop_train_and_eval(agent, early_stopping_rounds=100, early_stopping_threshold=7.0, eval_threshold=5.0,
                                 name_string="dqn resnet gridnone",
                                 train_epochs=2500, train_loops=3, eval_loops=3)
    ...
    def test_train_and_eval_gridone_resnet(self):
        ...
        self.loop_train_and_eval(agent, early_stopping_rounds=100, early_stopping_threshold=5.5, eval_threshold=3.5,
                                 name_string="dqn resnet gridone",
                                 train_epochs=2500, train_loops=3, eval_loops=3)
    ...
    def test_train_and_eval_gridtwo_resnet(self):
        ...
        self.loop_train_and_eval(agent, early_stopping_rounds=100, early_stopping_threshold=5.0, eval_threshold=3.0,
                                 name_string="dqn resnet gridtwo",
                                 train_epochs=3000, train_loops=3, eval_loops=3)
