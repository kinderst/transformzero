...
and handle validation data, and a few other minor adjustments
...
class GPT(nn.Module):
    ...
    def __init__(self, config):
        ...
        assert config.in_dim is not None
        assert config.out_dim is not None
        ...
        self.transformer = nn.ModuleDict(dict(
            ...
            wte=nn.Linear(config.in_dim, config.n_embd),
    ...
    # TODO: Come back and have it generate for time series
